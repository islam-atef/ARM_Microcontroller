...
typedef struct{
	...
	USART_INT_TYPE   Callback_Flag;        		/*	  UART Additional function that execute inside the Handler    */
...
///@retval Functions Status
Uart_Fun_Status 	MCAL_UART_Receive( USART_HANDLE *USARTx , u8 *ptData ,u16 Size_Limit , u32 Time_Limit, u8 Last_element);
/*---------------------------------------------------------------------------------------------------------------------------------------------------*/
