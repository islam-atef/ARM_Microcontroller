...
/*  Discribtion : This Function Enable the INT of the Peripheral on NVIC   									*/
/************************************************************************************************************/
...
/*  I/P parameters : interrupt ID                                          									*/
/*  Returnning : Returns Nothing                                           									*/
/*  Discribtion : This Function Disable the INT of the Peripheral on NVIC  									*/
/************************************************************************************************************/
...
/*  I/P parameters : interrupt ID                                          									*/
/*  Returnning : Returns Nothing                                           									*/
/*  Discribtion : This Function Set the Pending Flag of the INT on NVIC    									*/
/************************************************************************************************************/
...
/*  I/P parameters : interrupt ID                                          									*/
/*  Returnning : Returns Nothing                                           									*/
/*  Discribtion : This Function Clear the Pending Flag of the INT on NVIC  									*/
/************************************************************************************************************/
...
/*  I/P parameters : interrupt ID                                          									*/
/*  Returnning : Returns the Value of The Active Flag of The INT           									*/
/*  Discribtion : This Function Read the Vale Of Active Flag Of the INT    									*/
/************************************************************************************************************/
...
/*  Returnning : Returns Nothing								       									    */
/*  Discribtion : This Function Set the Ratio Between Groups and Subgroups in AIRCR Register an SCB Peri    */
/************************************************************************************************************/
...
/*  I/P parameters : interrupt ID    	                                								    */
/*  Returnning : Returns Nothing								       									    */
/*  Discribtion : This Function Set the Priority of the INT 												*/
/************************************************************************************************************/
void    MNVIC_voidSetINTPriority( s8 copy_S8INTID , u8 copy_U8GroupNUM , u8 copy_U8SubgroupNUM )
{
	u8 Group_Subgroup_Vale  =  ( (( copy_U8GroupNUM << (Group_to_Subgroup_Ratio - 3)) | (copy_U8SubgroupNUM) ) << (4) ) ;
	if (copy_S8INTID < 0 )
	{
		switch (copy_S8INTID)
		{
